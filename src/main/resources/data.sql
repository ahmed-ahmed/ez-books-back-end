...
-- --
INSERT INTO "PUBLIC"."role" ("role_name", "description") VALUES ('ROLE_STANDARD_USER', 'Standard User - Has no admin rights');
-- INSERT INTO "role" ("role_name", "description") VALUES ('ROLE_ADMIN_USER', 'Admin User - Has permission to perform admin tasks');
--
-- --
-- -- TOC entry 3842 (class 0 OID 14651287)
-- -- Data for Name: user; Type: TABLE DATA; Schema: public; Owner: -
-- --
-- INSERT INTO "user" ("first_name", "last_name", "password", "username", "tenant_id") VALUES ('User', 'User', '{bcrypt}$2a$09$T6t3qjpZqXXiLoP/1Lv9UOESra9QJp9VVPRm5XY8f3Lxoo4gcsMwS', 'user', 'user');
-- INSERT INTO "user" ("first_name", "last_name", "password", "username", "tenant_id") VALUES ('Admin', 'Admin', '{bcrypt}$2a$09$6NQhK6rkbcjqg5tL4offo.Rf66M9XDJ.qPxN/BRjEH4MEWT420oP6', 'admin', 'admin');
--
-- --
